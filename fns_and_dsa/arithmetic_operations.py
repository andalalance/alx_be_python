...
# For division, include handling for division by zero, returning a specific message 
# or value that your main.py script can recognize and display appropriately.
# Return the result of the arithmetic operation.

# A function named perform_operation.
